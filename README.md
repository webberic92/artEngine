...
![](https://github.com/HashLips/artEngine/blob/main/logo.png)
...
![](https://github.com/HashLips/artEngine/blob/main/banner.png)
...
```sh
git clone https://github.com/HashLips/artEngine.git
```
